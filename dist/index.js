...
function handleCardSelected(card) {
    ...
    if (card && !card.dataset.clicked) {
        ...
        visible === null || visible === void 0 ? void 0 : visible.classList.add('visible');
    ...
    if (selectedCards.length === 2) {
        ...
        // 2 card khác nhau
            ...
            setTimeout(() => {
                ...
                removeVisibleCard1 === null || removeVisibleCard1 === void 0 ? void 0 : removeVisibleCard1.classList.remove("visible");
                removeVisibleCard2 === null || removeVisibleCard2 === void 0 ? void 0 : removeVisibleCard2.classList.remove("visible");
            }, 1000);
        }
        if (turnOfPlay === 0) {
            setTimeout(() => {
